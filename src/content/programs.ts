...
export const programCategories: ProgramCategory[] = [
  ...
  },
  {
    ...
    overview:
      "Microsoft, AI, and digital skills programmes focus on tools people use at work every day. The category includes Excel, Power BI, Microsoft Office productivity, AI prompting, social media execution, cyber awareness, and practical data habits for teams that need faster, cleaner, more confident output.",
    focusAreas: ["Excel", "Power BI", "AI prompting", "Cyber awareness", "Digital productivity"],
    ...
    relatedCategorySlugs: ["finance-taxation", "sales-marketing-customer-service", "quality-lean-food-safety"],
  },
  {
  ...
  },
  {
    ...
    relatedCategorySlugs: ["microsoft-ai-digital-skills", "supply-chain-shipping-warehousing", "hr-employment-law"],
  },
  {
